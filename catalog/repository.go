...
type Repository interface {
	...
	ListProducts(ctx context.Context, skip int, take int) ([]Product, error)
...
func (r *elasticRepository) ListProducts(ctx context.Context, skip int, take int) ([]Product, error) {
